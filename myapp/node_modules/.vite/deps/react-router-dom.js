...
var _q, _WaitGroup_instances, waitQueue_fn, _a;
var WaitGroup = (_a = class {
  constructor() {
    __privateAdd(this, _WaitGroup_instances);
  ...
  add() {
    ...
    if (--this.p === 0) {
      let r;
      while ((r = __privateGet(this, _q).shift()) !== void 0) {
        r();
      }
    }
  }
  wait() {
    return new Promise(__privateMethod(this, _WaitGroup_instances, waitQueue_fn).bind(this));
  }
}, _q = new WeakMap(), _WaitGroup_instances = new WeakSet(), waitQueue_fn = function(resolve) {
  if (this.p === 0) {
    resolve();
  } else {
    __privateGet(this, _q).push(resolve);
  }
}, _a);
var Deferred = class {
  constructor() {
...
var _deferred, _next, _a2;
var DeferredAsyncIterable = (_a2 = class {
  constructor() {
    __publicField(this, "iterable");
    __privateAdd(this, _deferred, new Deferred());
    __privateAdd(this, _next, __privateGet(this, _deferred));
    this.iterable = (async function* () {
      let next = __privateGet(this, _deferred);
      while (true) {
  ...
  resolve() {
    __privateGet(this, _next).resolve({ done: true });
  }
  reject(error) {
    __privateGet(this, _next).promise.catch(() => {
    });
    __privateGet(this, _next).reject(error);
  }
  yield(value) {
    const deferred = new Deferred();
    __privateGet(this, _next).resolve({
      done: false,
      value,
      next: deferred
    });
    __privateSet(this, _next, deferred);
  }
}, _deferred = new WeakMap(), _next = new WeakMap(), _a2);
var DeferredReadableStream = class extends DeferredAsyncIterable {
  constructor() {
    super(...arguments);
    __publicField(this, "readable", new ReadableStream({
...
var _size, _type, _slice, _a3;
var TurboBlob = (_a3 = class extends Blob {
  constructor(from, start, end, contentType) {
    ...
    if (typeof from !== "undefined") {
      ...
      let nextStart = __privateGet(from, _slice).start ?? 0;
      if (typeof start !== "undefined") {
        nextStart += start;
      }
      __privateGet(this, _slice).start = nextStart;
      let nextEnd = __privateGet(from, _slice).end;
      if (typeof end !== "undefined") {
        nextEnd = (__privateGet(from, _slice).start ?? 0) + end;
      }
      __privateGet(this, _slice).end = nextEnd;
      __privateSet(this, _type, contentType ?? (from == null ? void 0 : from.type));
      __privateSet(this, _size, (nextEnd ?? from.size) - nextStart);
    }
  }
  get size() {
    if (typeof __privateGet(this, _size) === "undefined") {
  ...
  get type() {
    if (typeof __privateGet(this, _type) === "undefined") {
  ...
  async arrayBuffer() {
    ...
    if (__privateGet(this, _slice)) {
      return buffer.slice(
        __privateGet(this, _slice).start,
        __privateGet(this, _slice).end
      );
    }
    return buffer;
  }
  ...
  slice(start, end, contentType) {
    return new _a3(this, start, end, contentType);
  }
  stream() {
...
}, _size = new WeakMap(), _type = new WeakMap(), _slice = new WeakMap(), _a3);
var FileBaseClass = SUPPORTS_FILE ? File : Blob;
var _size2, _type2, _name, _lastModified, _slice2, _a4;
var TurboFile = (_a4 = class extends FileBaseClass {
  constructor(from, start, end, contentType) {
    var __super = (...args) => {
      super(...args);
      __publicField(this, "promise");
      ...
      __privateAdd(this, _lastModified);
      __privateAdd(this, _slice2, {});
      return this;
    };
    if (SUPPORTS_FILE) {
      __super([], "");
    ...
    if (typeof from !== "undefined") {
      this.promise = from.promise;
      let nextStart = __privateGet(from, _slice2).start ?? 0;
      if (typeof start !== "undefined") {
        nextStart += start;
      }
      __privateGet(this, _slice2).start = nextStart;
      let nextEnd = __privateGet(from, _slice2).end;
      if (typeof end !== "undefined") {
        nextEnd = (__privateGet(from, _slice2).start ?? 0) + end;
      }
      __privateGet(this, _slice2).end = nextEnd;
      __privateSet(this, _type2, contentType ?? (from == null ? void 0 : from.type));
      __privateSet(this, _name, from.name);
      __privateSet(this, _lastModified, from.lastModified);
    }
  }
  get name() {
    if (typeof __privateGet(this, _name) === "undefined") {
  ...
  get lastModified() {
    if (typeof __privateGet(this, _lastModified) === "undefined") {
      throw new Error("Last modified is not set");
    }
    return __privateGet(this, _lastModified);
  }
  set lastModified(value) {
    __privateSet(this, _lastModified, value);
  }
  get size() {
    if (typeof __privateGet(this, _size2) === "undefined") {
      throw new Error("Size is not set");
    }
    return __privateGet(this, _size2);
  }
  set size(value) {
    __privateSet(this, _size2, value);
  }
  get type() {
    if (typeof __privateGet(this, _type2) === "undefined") {
      throw new Error("Type is not set");
    }
  ...
  async arrayBuffer() {
    ...
    const buffer = await this.promise;
    if (__privateGet(this, _slice2)) {
      return buffer.slice(
        __privateGet(this, _slice2).start,
        __privateGet(this, _slice2).end
      );
    }
    return buffer;
  }
  ...
  slice(start, end, contentType) {
    return new _a4(this, start, end, contentType);
  }
  stream() {
    return new ReadableStream({
      start: async (controller) => {
...
}, _size2 = new WeakMap(), _type2 = new WeakMap(), _name = new WeakMap(), _lastModified = new WeakMap(), _slice2 = new WeakMap(), _a4);
var MODE_UNKNOWN = 0;
var MODE_NUMBER = 1;
var MODE_STRING = 2;
var MODE_ASYNC = 3;
...
function flattenRoutes(routes, branches = [], parentsMeta = [], parentPath = "") {
  ...
  routes.forEach((route, index) => {
    var _a5;
    if (route.path === "" || !((_a5 = route.path) == null ? void 0 : _a5.includes("?"))) {
...
function createRouter(init) {
  ...
  function completeNavigation(location, newState, { flushSync: flushSync2 } = {}) {
    var _a5, _b;
    let isActionReload = state.actionData != null && state.navigation.formMethod != null && isMutationMethod(state.navigation.formMethod) && state.navigation.state === "loading" && ((_a5 = location.state) == null ? void 0 : _a5._isRedirect) !== true;
    let actionData;
...
function getMatchesToLoad(request, scopedContext, mapRouteProperties2, manifest, history, state, matches, submission, location, lazyRoutePropertiesToSkip, initialHydration, isRevalidationRequired, cancelledFetcherLoads, fetchersQueuedForDeletion, fetchLoadMatches, fetchRedirectIds, routesToUse, basename, pendingActionResult) {
  ...
  let baseShouldRevalidateArgs = {
    currentUrl,
    currentParams: ((_a5 = state.matches[0]) == null ? void 0 : _a5.params) || {},
    nextUrl,
...
function isSameRoute(newRoute, existingRoute) {
  ...
  return newRoute.children.every(
    (aChild, i) => {
      var _a5;
      return (_a5 = existingRoute.children) == null ? void 0 : _a5.some((bChild) => isSameRoute(aChild, bChild));
    }
  );
}
...
async function callDataStrategyImpl(dataStrategyImpl, request, matches, fetcherKey, scopedContext, isStaticHandler) {
  if (matches.some((m) => {
    var _a5;
    return (_a5 = m._lazyPromises) == null ? void 0 : _a5.middleware;
  })) {
  ...
  try {
    await Promise.all(
      matches.flatMap((m) => {
        var _a5, _b;
        return [(_a5 = m._lazyPromises) == null ? void 0 : _a5.handler, (_b = m._lazyPromises) == null ? void 0 : _b.route];
      })
    );
  } catch (e) {
  }
    ...
    if (isDataWithResponseInit(result)) {
      if (result.data instanceof Error) {
        return {
          type: "error",
          error: result.data,
          statusCode: (_a5 = result.init) == null ? void 0 : _a5.status,
...
Please change the parent <Route path="${parentPath}"> to <Route path="${parentPath === "/" ? "*" : `${parentPath}/*`}">.`
  ...
  if (locationArg) {
    ...
    invariant(
      parentPathnameBase === "/" || ((_a5 = parsedLocationArg.pathname) == null ? void 0 : _a5.startsWith(parentPathnameBase)),
...
function useRouteError() {
  ...
  return (_a5 = state.errors) == null ? void 0 : _a5[routeId];
}
...
function getKeyedLinksForMatches(matches, routeModules, manifest) {
  let descriptors = matches.map((match) => {
    ...
    return [
      ...
      ((_a5 = module == null ? void 0 : module.links) == null ? void 0 : _a5.call(module)) || []
    ];
  }).flat(2);
...
function getNewMatchesForLinks(page, nextMatches, currentMatches, manifest, location, mode) {
  ...
  let matchPathChanged = (match, index) => {
    ...
    return (
      ...
      // e.g. /files/images/avatar.jpg -> files/finances.xls
      ((_a5 = currentMatches[index].route.path) == null ? void 0 : _a5.endsWith("*")) && currentMatches[index].params["*"] !== match.params["*"]
    );
  };
  if (mode === "assets") {
    ...
    return nextMatches.filter((match, index) => {
      ...
      if (match.route.shouldRevalidate) {
        let routeChoice = match.route.shouldRevalidate({
          ...
          currentParams: ((_a5 = currentMatches[0]) == null ? void 0 : _a5.params) || {},
...
function BoundaryShell({
  ...
  if (((_a5 = routeModules.root) == null ? void 0 : _a5.Layout) && !isOutsideRemixApp) {
    return children;
  }
...
function createClientRoutes(manifest, routeModulesCache, initialState, ssr, isSpaMode, parentId = "", routesByParentId = groupRoutesByParentId(manifest), needsRevalidation) {
  return (routesByParentId[parentId] || []).map((route) => {
    ...
    if (routeModule) {
      ...
      let initialData = hasInitialData ? (_a5 = initialState == null ? void 0 : initialState.loaderData) == null ? void 0 : _a5[route.id] : void 0;
...
function useFogOFWarDiscovery(router2, manifest, routeModules, ssr, isSpaMode) {
  React8.useEffect(() => {
    var _a5;
    if (!isFogOfWarEnabled(ssr) || ((_a5 = navigator.connection) == null ? void 0 : _a5.saveData) === true) {
      return;
    }
...
function Scripts(props) {
  ...
  let initialScripts = React9.useMemo(() => {
    ...
    let routeModulesScript = !isStatic ? " " : `${((_a5 = manifest.hmr) == null ? void 0 : _a5.runtime) ? `import ${JSON.stringify(manifest.hmr.runtime)};` : ""}${!enableFogOfWar ? `import ${JSON.stringify(manifest.url)}` : ""};
...
function useFetcher({
  ...
  let routeId = (_a5 = route.matches[route.matches.length - 1]) == null ? void 0 : _a5.route.id;
...
var createRequestHandler = (build, mode) => {
  ...
  return async function requestHandler(request, initialContext) {
    ...
    let handleError = (error) => {
      var _a6, _b2;
      if (mode === "development") {
        (_b2 = (_a6 = getDevServerHooks()) == null ? void 0 : _a6.processRequestError) == null ? void 0 : _b2.call(_a6, error);
      }
      errorHandler(error, {
        context: loadContext,
        params,
...
Error: ${e instanceof Error ? e.toString() : e}`
    ...
    if (url.pathname.endsWith(".data")) {
      ...
      } else if (mode === "development" && ((_a5 = getDevServerHooks()) == null ? void 0 : _a5.getCriticalCss)) {
...
function createHydratedRouter({
  ...
  if (ssrInfo.context.isSpaMode) {
    if (((_a5 = ssrInfo.manifest.routes.root) == null ? void 0 : _a5.hasLoader) && loaderData && "root" in loaderData) {
      hydrationData = {
        loaderData: {
